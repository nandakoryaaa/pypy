...
class ModalView(View):
  def __init__(self, graphics, model):
    ...
    self.x = (self.graphics.width - self.img_shadow.get_width()) // 2
    self.y = (self.graphics.height - self.img_shadow.get_height()) // 2
    self.back_x = (self.graphics.width - self.img_back.get_width()) // 2
    self.back_y = (self.graphics.height - self.img_back.get_height()) // 2
